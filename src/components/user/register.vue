  ...
  <el-dialog :visible.sync="dialogVisible" width="500px" v-loading="loadingVisible" @open="handleDialogOpen()">
    ...
    <el-form :model="userModel" :rules="formRules" class="el-dialog-form"
      ...
      <el-form-item label="二级密码" prop="secondaryPwd">
        <el-col :span="16"><el-input type="secondaryPwd" :maxlength="16" v-model="userModel.secondaryPwd" auto-complete="off"></el-input></el-col>
      </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      formRules: {
        ...
        checkPassword: [
            { required: true, message: '请重复二级密码', trigger: 'blur' },
