<template>
  <el-dialog :visible.sync="dialogVisible" :modal-append-to-body="false" width="500px" v-loading="loadingVisible">
    ...
    <div class="list-container">
      <div class="user-list-container left-list">
        ...
        <ul>
          <li v-for="(item, index) in this.userList" @click="selectUser(item, index)" v-html="readerName(item)" ><span>+</span></li>
      ...
      <div class="user-list-container right-list">
        ...
        <ul>
          <li v-for="(item, index) in this.selectedUserList" @click="unselectUser(item, index)" v-html="readerName(item)"><span>x</span></li>
        </ul>
      </div>
    </div>
